...
contract PriceBetTest {
    ...
    /// @notice Property: owner-cannot-receive-before-deadline-not-player
    function check_owner_cannot_receive_before_deadline_not_player(
        uint256 initialPot,
        uint256 timeout,
        address player,
        address caller,
